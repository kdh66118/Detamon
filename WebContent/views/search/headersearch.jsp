...
<body>
	...
	<!-- 게시판 타이틀 -->
	<div id="boardtitle">
		<span id="title">Search</span><span id="title2"><span id="title3">&nbsp&nbsp'${searchword }'</span> 에 대한 통합 검색결과입니다.</span>
		
	</div>
	
	<form action="controller.do" method="post" id="searchform">
		<input type="hidden" name="command" value="headersearch" id="command">
